...
export default function Home() {
  const menuLinks = [
    { link: "/view-data", name: "View Data", color: "border-blue-600" },
    {
      link: "/find-country",
      name: "Find Data by Country",
    ...
    { link: "/sort", name: "Sort Data", color: "border-purple-600" },
  ];
  return (
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start">
        ...
        <ol start={1} type="1" className="flex flex-row gap-10 list-decimal">
          {menuLinks.map((e) => (
            <li
              key={e.link}
              className={`text-center border-4 mb-5 ${e.color} text-xl hover:underline hover:underline-offset-2`}
            >
